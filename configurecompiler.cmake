...
if(CMAKE_SYSTEM_NAME STREQUAL Linux)
    ...
    if(CLR_CROSS_COMPONENTS_BUILD)
        ...
        if(CMAKE_HOST_SYSTEM_PROCESSOR STREQUAL x86_64 OR CMAKE_HOST_SYSTEM_PROCESSOR STREQUAL amd64)
            if(CLR_CMAKE_TARGET_ARCH STREQUAL "arm" OR CLR_CMAKE_TARGET_ARCH STREQUAL "armel" OR CLR_CMAKE_TARGET_ARCH STREQUAL "ppc64el")
	...
	elseif(CMAKE_SYSTEM_PROCESSOR STREQUAL ppc64el)
	    set(CLR_CMAKE_PLATFORM_UNIX_PPC64EL 1)
...
elseif(CLR_CMAKE_PLATFORM_UNIX_PPC64EL)
    set(CLR_CMAKE_PLATFORM_ARCH_PPC64EL 1)
    set(CLR_CMAKE_HOST_ARCH "PPC64EL")
elseif(WIN32)
    ...
    elseif(CLR_CMAKE_HOST_ARCH STREQUAL arm64)
        set(CLR_CMAKE_PLATFORM_ARCH_ARM64 1)
    elseif(CLR_CMAKE_HOST_ARCH STREQUAL ppc64el)
	set(CLR_CMAKE_PLATFORM_ARCH_PPC64EL 1)
    else()
        clr_unknown_arch()
    endif()
...
if (CLR_CMAKE_TARGET_ARCH STREQUAL x64)
  ...
  elseif(CLR_CMAKE_TARGET_ARCH STREQUAL armel)
    set(CLR_CMAKE_TARGET_ARCH_ARM 1)
    set(ARM_SOFTFP 1)
  elseif(CLR_CMAKE_TARGET_ARCH STREQUAL PPC64EL)
    set(CLR_CMAKE_TARGET_ARCH_PPC64EL 1)
  else()
    clr_unknown_arch()
endif()
...
if(NOT(CLR_CMAKE_TARGET_ARCH STREQUAL CLR_CMAKE_HOST_ARCH))
      if(NOT((CLR_CMAKE_PLATFORM_ARCH_AMD64 AND CLR_CMAKE_TARGET_ARCH_ARM64) OR (CLR_CMAKE_PLATFORM_ARCH_I386 AND CLR_CMAKE_TARGET_ARCH_ARM) OR (CLR_CMAKE_PLATFORM_ARCH_AMD64 AND CLR_CMAKE_TARGET_ARCH_ARM) OR (CLR_CMAKE_PLATFORM_ARCH_AMD64 AND CLR_CMAKE_TARGET_ARCH_PPC64EL)))
...
elseif (CLR_CMAKE_PLATFORM_ARCH_ARM64)
  ...
  add_definitions(-DBIT64)
elseif (CLR_CMAKE_PLATFORM_ARCH_PPC64EL)
  add_definitions(-D_PPC64EL_)
  add_definitions(-DPP64EL)
  add_definitions(-DBIT64)
else ()
  clr_unknown_arch()
endif ()
...
if (CLR_CMAKE_PLATFORM_UNIX)
  if(CLR_CMAKE_PLATFORM_LINUX)
    ...
    elseif(CLR_CMAKE_PLATFORM_UNIX_X86)
      ...
      add_definitions(-DLINUX32)
    elseif(CLR_CMAKE_PLATFORM_UNIX_PPC64EL)
      message("Detected Linux ppc64el")
      add_definitions(-DLINUX64)
    else()
      clr_unknown_arch()
    endif()
...
elseif (CLR_CMAKE_TARGET_ARCH_PPC64EL)
    set(ARCH_SOURCES_DIR PPC64EL)
else ()
    clr_unknown_arch()
endif ()
...
if (MSVC)
  ...
  if (CLR_CMAKE_TARGET_ARCH_ARM OR CLR_CMAKE_TARGET_ARCH_ARM64 OR CLR_CMAKE_TARGET_ARCH_PPC64EL)
    # Contracts work too slow on ARM/ARM64 DEBUG/CHECKED.
    add_definitions(-DDISABLE_CONTRACTS)
  endif (CLR_CMAKE_TARGET_ARCH_ARM OR CLR_CMAKE_TARGET_ARCH_ARM64 OR CLR_CMAKE_TARGET_ARCH_PPC64EL)
