...
elseif(TARGET_ARCH_NAME STREQUAL "ppc64el")
  ...
  include_directories(SYSTEM ${CROSS_ROOTFS}/usr/lib/powerpc64le-linux-gnu/)
  include_directories(SYSTEM ${CROSS_ROOTFS}/usr/lib/gcc/powerpc64le-linux-gnu/7/)
  include_directories(SYSTEM ${CROSS_ROOTFS}/usr/include/powerpc64le-linux-gnu//)
else()
  message(FATAL_ERROR "Arch is ${TARGET_ARCH_NAME}. Only armel, arm, arm64, x86 and ppc64el are supported!")
endif()
...
if(TARGET_ARCH_NAME MATCHES "^(arm|armel|arm64|ppc64el)$")
